...
\input{sections/crittografia_simmetrica}
\input{sections/hash_mac}
\input{sections/attack_model}
\input{sections/symm_schema_integrity}
\input{sections/randomness}
\input{sections/symmetric_other}
\input{sections/auth_protocol_1}
\input{sections/asymm_crypto}
\input{sections/attack_model_ds}
\input{sections/auth_protocol_2}
\input{sections/secure_communication_protocols}
\input{sections/pki}
